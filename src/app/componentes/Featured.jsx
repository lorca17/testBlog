            ...
            items.map((e)=>{
              return (
                ...
                <a href={e.slug}>
                    ...
                    <div className="mx-2 flex items-center justify-center bg-gray-300 bg-cover bg-center relative rounded overflow-hidden" style={{"background-image":`url(${e.data.imagen})`}}>
                        <div className="absolute w-full h-full bg-black z-10 opacity-50"></div>
                        <div className="relative z-20 text-center p-5">
                            <span className="inline-block text-white uppercase text-xs tracking-wide">{e.data.categoria}</span>
